...
exports.bundleContextual = require('./test-vectors/fixtures/bundle_contextual.json');
...
exports.expectedContextual = require('./test-vectors/fixtures/expected_contextual.json');
...
exports.testVectorPaths = {
  ...
  bundleContextual: path.join(__dirname, 'test-vectors/fixtures/bundle_contextual.json'),
  ...
  expectedContextual: path.join(__dirname, 'test-vectors/fixtures/expected_contextual.json'),
